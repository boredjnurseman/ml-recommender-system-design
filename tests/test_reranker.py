...
# The base order favours the more relevant and popular candidate.
candidate_pair = [candidate1, candidate2]

ROOT = Path(__file__).parent.parent

conservative_policy = load_policy(ROOT / "config/policy-v1.yaml")
discovery_policy = load_policy(ROOT / "config/policy-v2.yaml")
